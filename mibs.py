...
SNMP_OID_upsAdvConfigRatedOutputVoltage      = const2("1.3.6.1.4.1.318.1.1.1.5.2.1.0"),ASN1_INT #, 230
SNMP_OID_upsAdvConfigHighTransferVolt        = const2("1.3.6.1.4.1.318.1.1.1.5.2.2.0"),ASN1_INT #, 253
SNMP_OID_upsAdvConfigLowTransferVolt         = const2("1.3.6.1.4.1.318.1.1.1.5.2.3.0"),ASN1_INT #, 161
SNMP_OID_upsAdvConfigMinReturnCapacity       = const2("1.3.6.1.4.1.318.1.1.1.5.2.6.0"),ASN1_INT #, 35
SNMP_OID_upsAdvConfigSensitivity             = const2("1.3.6.1.4.1.318.1.1.1.5.2.7.0"),ASN1_INT #, 0
...
SNMP_OID_upsAdvControlBypassSwitch           = const2("1.3.6.1.4.1.318.1.1.1.6.2.7.0"),ASN1_INT #, 1 #INTEGER: noBypassSwitch(1)
