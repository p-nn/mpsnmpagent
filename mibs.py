...
SNMP_OID_upsAdvBatteryCapacity = const2(
    "1.3.6.1.4.1.318.1.1.1.2.2.1.0"), SNMP_GUAGE  # , 100    #                APC_CMD_BATTLEV
SNMP_OID_upsAdvBatteryTemperature = const2("1.3.6.1.4.1.318.1.1.1.2.2.2.0"), SNMP_GUAGE  # , 31 #Gauge32: 31
SNMP_OID_upsAdvBatteryRunTimeRemaining = const2(
    "1.3.6.1.4.1.318.1.1.1.2.2.3.0"), SNMP_TIMETICKS  # , 390000 #Timeticks: (390000) 1:05:00.00
SNMP_OID_upsAdvBatteryReplaceIndicator = const2(
    "1.3.6.1.4.1.318.1.1.1.2.2.4.0"), ASN1_INT  # , 1 #INTEGER: noBatteryNeedsReplacing(1)
...
SNMP_OID_upsAdvConfigSensitivity = const2(
    "1.3.6.1.4.1.318.1.1.1.5.2.7.0"), ASN1_INT  # , 0 read/write auto(1),low(2),medium(3),high(4)
SNMP_OID_upsAdvConfigLowBatteryRunTime = const2(
    "1.3.6.1.4.1.318.1.1.1.5.2.8.0"), SNMP_TIMETICKS  # ,  90000 #Timeticks: (90000) 0:15:00.00
SNMP_OID_upsAdvConfigReturnDelay = const2(
    "1.3.6.1.4.1.318.1.1.1.5.2.9.0"), SNMP_TIMETICKS  # , 2000 #Timeticks: (2000) 0:00:20.00
SNMP_OID_upsAdvConfigShutoffDelay = const2(
    "1.3.6.1.4.1.318.1.1.1.5.2.10.0"), SNMP_TIMETICKS  # , 2000 #Timeticks: (2000) 0:00:20.00
SNMP_OID_upsBasicControlConserveBattery = const2(
    "1.3.6.1.4.1.318.1.1.1.6.1.1.0"), ASN1_INT  # , 1 #NTEGER: noTurnOffUps(1)
SNMP_OID_upsAdvControlUpsOff = const2("1.3.6.1.4.1.318.1.1.1.6.2.1.0"), ASN1_INT  # , 1 #INTEGER: noTurnUpsOff(1)
SNMP_OID_upsAdvControlSimulatePowerFail = const2(
    "1.3.6.1.4.1.318.1.1.1.6.2.4.0"), ASN1_INT  # , 1 #INTEGER: noSimulatePowerFailure(1)
SNMP_OID_upsAdvControlFlashAndBeep = const2(
    "1.3.6.1.4.1.318.1.1.1.6.2.5.0"), ASN1_INT  # , 1 #INTEGER: noFlashAndBeep(1)
SNMP_OID_upsAdvControlTurnOnUPS = const2("1.3.6.1.4.1.318.1.1.1.6.2.6.0"), ASN1_INT  # , 1 # INTEGER: noTurnOnUPS(1)
SNMP_OID_upsAdvControlBypassSwitch = const2(
    "1.3.6.1.4.1.318.1.1.1.6.2.7.0"), ASN1_INT  # , 1 #INTEGER: noBypassSwitch(1) #noBypassSwitch (1),switchToBypass (2),switchOutOfBypass(3)
SNMP_OID_upsAdvTestDiagnostics = const2("1.3.6.1.4.1.318.1.1.1.7.2.2.0"), ASN1_INT  # , 1 #INTEGER: noTestDiagnostics(1)
SNMP_OID_upsAdvTestRuntimeCalibration = const2(
    "1.3.6.1.4.1.318.1.1.1.7.2.5.0"), ASN1_INT  # , 1 #INTEGER: noPerformCalibration(1)
...
SNMP_OID_upsPhaseInputFrequency = const2("1.3.6.1.4.1.318.1.1.1.9.2.2.1.4.1"), ASN1_INT #-1 FreeBSD NUT require :-(
SNMP_OID_upsPhaseInputMinVoltage = const2("1.3.6.1.4.1.318.1.1.1.9.2.3.1.5.1.1.3"), ASN1_INT #-1 FreeBSD NUT require :-(
SNMP_OID_upsPhaseOutputMaxCurrent = const2("1.3.6.1.4.1.318.1.1.1.9.3.3.1.5.1.1.3"), ASN1_INT #-1  FreeBSD NUT require :-(
SNMP_OID_upsPhaseOutputPercentLoad = const2("1.3.6.1.4.1.318.1.1.1.9.3.3.1.9.1.1.1"), ASN1_INT #-1  FreeBSD NUT require :-(
